(function(){
  ...
  function bootDeratWidget(){
    ...
    var WIDGET_URL='https://derat-chatbot-backend.vercel.app/widget.html?v=mobile-keyboard-3';
    ...
    shadow.innerHTML=`
      <style>
        ...
        .dt-title{display:block;margin:0 18px 3px 0;color:#39393a;font-size:14.5px;font-weight:800;line-height:1.3}
        .dt-text{display:block;color:#6b6b6c;font-size:12.5px;font-weight:500;line-height:1.5}
    ...
    readyFallbackTimer=setTimeout(markReady,8000);
